...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/geirina/Weymouth.png" title="linearized_weymouth" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/geirina/heat.png" title="linearized_heat" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
where $0<\frac{\lambda_b L_b}{c_p m_{b, t}^{p, r}} << 1$. Since $e^{-x} \approx 1-x$, we have
